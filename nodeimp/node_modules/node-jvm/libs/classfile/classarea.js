...
ClassArea.prototype.getSuperClassName = function() {    
    ...
    {
        //zixing added
        console.error("getSuperClassName error "+err);
...
var getClassImage = function(classBytes) {
    ...
    var getAttributes = function(attribute_name_index, bytes) {
        ...
        //console.log('item',item,attribute_name_index) //
        switch(item.tag) {
            ...
            case TAGS.CONSTANT_Utf8:
                ...
                switch(item.bytes) { 
                    ...
                    case ATTRIBUTE_TYPES.ConstantValue:
    ...
    for(var i=1; i<constant_pool_count; i++) {        
        ...
        switch(tag) {
            ...
            case TAGS.CONSTANT_Long:
                ...
                var high_bytes =  reader.read32();
                var low_bytes =  reader.read32();
                classImage.constant_pool.push( {  tag: tag, high_bytes: high_bytes,low_bytes:low_bytes,value:longToNumber(low_bytes,high_bytes) } );
                classImage.constant_pool.push( null ); i++;
                break;
