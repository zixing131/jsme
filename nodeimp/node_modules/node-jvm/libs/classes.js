...
Classes.prototype.getClass = function(className) { 
    ...
    // if(className.indexOf('ConsoleOutputStream')>-1)
    // { 
    //     console.log("getClass : "+className); 
    //     for(var i=0; i<this.paths.length; i++) {
    //         var fileName = util.format("%s/javarep/%s", this.paths[i], className);
    //     }
    ...
    try{
        ...
        if (ca instanceof ClassArea) {
            ...
            for(var i=0; i<methods.length; i++) 
                ...
                {
                    var cptemp=cp[methods[i].name_index]
                    if (cptemp && cptemp.bytes === methodName)
                    {
